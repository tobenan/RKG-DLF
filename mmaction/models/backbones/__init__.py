...
from .x3d import X3D
from .fusenet_res import FuseNet
from .ctanet import CTANet
from .cnnTransformer import CNNTransformer
from .timesformer1 import TimeSformer1
from .res import RES
from .resnet_resvit import ResNetforVit
from .fusenet_cat_res import FuseNetcat
...
__all__ = [
    ...
    'TimeSformer', 'STGCN', 'AGCN', 'FuseNet', 'CTANet', 'CNNTransformer','TimeSformer1','RES','ResNetforVit',
    'FuseNetcat',
]
